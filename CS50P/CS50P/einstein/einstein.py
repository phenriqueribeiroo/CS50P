# Even if you haven’t studied physics (recently or ever!), you might
# have heard that E = mc², wherein E represents energy (measured in
...
# second), per Albert Einstein et al. Essentially, the formula means
...
# outputs the equivalent number of Joules as an integer. Assume that the
